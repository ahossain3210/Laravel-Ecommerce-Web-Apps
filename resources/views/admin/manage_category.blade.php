            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                            @if($v_category->publication_status==1)
                            <a class="btn btn-danger" href="{{URL::to('/unpublish-category/'.$v_category->category_id)}}">
                                <i class="halflings-icon white thumbs-down" title="Unpublish"></i>  
                            </a>
                            @else
                            <a class="btn btn-success" href="{{URL::to('/publish-category/'.$v_category->category_id)}}">
