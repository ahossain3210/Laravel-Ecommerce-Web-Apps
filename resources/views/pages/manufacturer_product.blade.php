...
<h2 class="tt_uppercase m_bottom_20 color_dark heading1 animate_ftr">All Products of <b style="color: green;">{{$manufacturer_info->manufacturer_name}}</b> Brands are available here..</h2>
...
<section class="products_container clearfix m_bottom_25 m_sm_bottom_15">
    <!--product item-->
    @foreach($manufacturer_product_info as $v_product)
    <div class="product_item m_bottom_40">
