...
<h2 class="tt_uppercase m_bottom_20 color_dark heading1 animate_ftr"><b style="color: green;"><i>{{$nested_category_info->nested_category_name}}</i></b>  Collection</h2>
...
<section class="products_container clearfix m_bottom_25 m_sm_bottom_15">
    ...
    <div class="product_item m_bottom_40 {{$v_product->manufacturer_id}}">
        <figure class="r_corners photoframe shadow relative hit animate_ftb long">
            ...
            <figcaption>
                <h6 class="m_bottom_5"><a href="#" class="color_dark">{{$v_product->product_name}}</a></h6>
                    <div class="clearfix">
