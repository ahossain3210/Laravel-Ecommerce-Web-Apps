...
<section class="breadcrumbs">
    <div class="container">
        <ul class="horizontal_list clearfix bc_list f_size_medium">
            <li class="m_right_10 current"><a href="{{URL::to('/')}}" class="default_t_color"><i class="fa fa-home"></i><i class="fa fa-angle-right d_inline_middle m_left_10"></i></a></li>
            <li>Contacts</li>
        </ul>
    </div>
</section>
            ...
            <section class="col-lg-9 col-md-9 col-sm-9">
                ...
                <div class="row clearfix">
                        ...
                        <ul class="c_info_list">
                            ...
                            <li class="m_bottom_10">
                                <div class="clearfix m_bottom_10">
                                    ...
                                    <a class="contact_e default_t_color" href="mailto:#">shopin@infobd.com</a>
                                </div>
                            </li>
                            <li>
                                <div class="clearfix">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 m_xs_bottom_30">
                        ...
                        <p class="m_bottom_15">You are always welcomed to our community. Please share your thoughts & ideas with us.</p>
                        ...
                        <h5 class="scheme_color m_top_20">
                            <?php
