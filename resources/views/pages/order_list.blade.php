...
//                        ?>
                        <tr>
                            <!--order number-->
                            <td data-title="Order Number"><a href="order_details.html" class="color_dark">{{ $i, $i++}}</a></td>
                            <!--order date-->
                            <td data-title="Order Status"><?php echo date('d-M-Y',  strtotime($v_order_info->order_date))?></td>
                            <td data-title="Order Date">{{$v_order_info->product_name}}</td>
                            <td data-title="Order Date">{{$v_order_info->product_sales_quantity}}</td>
                            <td data-title="Order Date">{{$v_order_info->payment_method}}</td>
                            <td data-title="Order Date">BDT {{$v_order_info->product_price}} </td>
                            <!--order status-->
                            <!--quanity-->
                ...
                <tbody>
                    <tr>
                        <td colspan="5"></td>
                        <td class="right"><b>Total : BDT {{Cart::total()}}</b></td>
                        <td class="right number"></td>
                    </tr>
                    <tr>
                        <td colspan="5"></td>
                        <td class="right"><b>Shipment fee :
                        <?php 
                        $shipment_fee=100;
                    ...
                    <tr>
                        <td colspan="5"></td>
                        <td class="right scheme_color"><b>Grand-Total : BDT <?php echo ($total+$shipment_fee)-$discount;?></b></td>
                        <td class="right number"></td>
                    </tr>
                </tbody>
            </table>
