            ...
            <section class="col-lg-9 col-md-9 col-sm-9 m_xs_bottom_30">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 m_top_5" style="padding: 0;">
                    <ul>
                        <li style="float: left;">
                            <a href="{{URL::to('/')}}">
                                <button class="button_type_6 r_corners bg_scheme_color color_light tr_delay_hover d_inline_b f_size_large" title="Continue shopping"><i class="fa fa-angle-double-left"></i> Continue Shopping</button>
                            </a>
                        </li>
                        <li style="float: right;">
                            ...
                            if ($customer_id !=NULL && $billing_id==NULL) {
                                ...
                                <a href="{{URL::to('/billing')}}">
                                    <button class="button_type_6 r_corners bg_scheme_color color_light tr_delay_hover d_inline_b f_size_large" title="Proceed to checkout"><b>Proceed to checkout</b> <i class="fa fa-angle-double-right"></i></button>
                                </a>
